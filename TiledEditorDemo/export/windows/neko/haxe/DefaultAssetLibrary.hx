...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/tiled/decorations/capa01_A.png", AssetType.IMAGE);
		path.set ("assets/tiled/decorations/capa01_B.png", "assets/tiled/decorations/capa01_B.png");
		type.set ("assets/tiled/decorations/capa01_B.png", AssetType.IMAGE);
		...
		type.set ("assets/tiled/logo.png", AssetType.IMAGE);
		className.set ("flixel/sounds/beep.ogg", __ASSET__flixel_sounds_beep_ogg);
		type.set ("flixel/sounds/beep.ogg", AssetType.SOUND);
		className.set ("flixel/sounds/flixel.ogg", __ASSET__flixel_sounds_flixel_ogg);
		type.set ("flixel/sounds/flixel.ogg", AssetType.SOUND);
		...
		id = "assets/tiled/decorations/capa01_A.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/tiled/decorations/capa01_B.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
