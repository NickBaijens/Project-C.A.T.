...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "TiledEditor", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "TiledEditor";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "TiledEditor", null, { width: 640, height: 480 });
