...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("CandyBacon Studios", "Last_Quest_HaxeFlixel", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Last_Quest_HaxeFlixel";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Last_Quest_HaxeFlixel", null, { width: 1280, height: 720 });
