...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "Template_Project", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Template_Project";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Template_Project", null, { width: 640, height: 480 });
